...
class Event {
    ...
    static void preparation() {
        Scanner reader = new Scanner(System.in);
        System.out.println("Váratlanul Creepy Guy lép oda hozzád, és közli, hogy névsorolvasás után várnak a " +
        ...
        if (n == 1) {
            ...
            System.out.println("Lezajlik a névsorolvasás. Közben felfigyelsz rá, hogy munkások egy bazinagy dobozt " +
                    "cipelnek ki az ajtón, de ez most nem izgat túlságosan. Creepy Guy és a mentorok bekísérnek a " +
                    "tárgyalóba, ahol közlik veled, hogy a sokadik figyelmeztetés ellenére már megint nem adtad le a házidat." +
                    "\nKI VAGY RÚGVA!\nBúcsuzóul néhány jótanács: https://www.youtube.com/watch?v=lUs01oxpjQw");
        }
        else if (n == 2) {
            emptyRoom();
        }
    ...
    private static void emptyRoom(){
        Scanner reader = new Scanner(System.in);
        if (balint.isLaptop){
            System.out.println("Az iroda hátsó részében egy indokolatlanul bazinagy dobozt találsz, és nem bírod " +
    ...
    static void meetingRoom(){
        System.out.println("Belépsz a tárgyalóba, ahol Creepy Guyt egyedül találod.");
        if (balint.isassignment) {
            ...
            balint.canplay = false;
            System.out.println("Megkér, hogy foglalj helyet, és behívja a mentorokat. Mindenki megérkezik, majd" +
    ...
    static void lunchBreak() {
        Scanner reader = new Scanner(System.in);
        System.out.println("Ez a délelőtt hosszú volt, de végre eljött az ebédszünet. Dani kérdezi, hogy " +
        ...
        if (n == 1) {
            ...
            lunch();
            balint.canplay = false;
            System.out.println("Az ebédből visszaérve azt tapasztalod, hogy a csocsóasztal több darabban van, " +
                    "Mikit pedig fehérruhás emberek kényszerzubbonyban kísérik ki az ajtón. Kérdezned sem kell, " +
    ...
    private static void play(){
        Scanner reader = new Scanner(System.in);
        System.out.println("Nagyon szoros a meccs, 5-5 az állás, kezedben a meccslabda. Mit teszel?\n" +
        ...
        if (n == 1) {
            System.out.println("Ez nem volt jó döntés. Miki megszerezte a labdát, és belőtte a győztes gólt " +
                    "és válogatott sértések közepette röhög a pofádba. Nem baj. Majd délután törlesztesz ezért.");
        }
        else if (n == 2) {
            balint.canplay = false;
    ...
    private static void lunch(){
        Scanner reader = new Scanner(System.in);
        System.out.println("Mivel otthon felejtetted a kajádat, el kell menned venni, de nem akarsz messzire menni, " +
    ...
    static void afternon(){
        System.out.println("Délután már tényleg nem történt semmi érdekes.\nElérted a célodat, elindulhatsz " +
    ...
    static void randomDestroy(){
        ...
        if (n >= 93) {
            balint.canplay = false;
            System.out.println("Váratlanul megjelent régen látott barátod András, aki közölte, hogy egy " +
                    "csitrilliárdot nyert tippmixen, és megvette a codecoolt.\nKözölte, hogy nem lesz itt " +
                    "semmiféle bajnokság, ugyanis egész nap ő fog csocsózni :D");
        }
        else if (n <= 93 && n >= 85) {
            balint.canplay = false;
            System.out.println("Becsapódott egy meteor az irodaházba. Hát így nem lesz bajnokság :P");
        }
    }
}
